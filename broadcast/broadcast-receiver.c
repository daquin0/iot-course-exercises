...
#include "sys/log.h"
#define LOG_MODULE "Boradcast Receiver App"
#define LOG_LEVEL LOG_LEVEL_INFO

#define WAIT_INTERVAL (5 * CLOCK_SECOND)

PROCESS(broadcast_reciever, "Broadcast Received Example");
AUTOSTART_PROCESSES(&broadcast_reciever);
...
PROCESS_THREAD(broadcast_reciever, ev,data)
{
